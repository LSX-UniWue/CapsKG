...
def asc_config(parser):
    ...
    parser.add_argument('--baseline', default='', type=str, required=True,
                        ...
                        choices=['ncl', 'one', 'mtl', 'l2', 'a-gem', 'derpp', 'kan', 'srk', 'ewc', 'hal', 'ucl', 'owm',
                                ...
                                'one_mlm', 'mtl_mlm', 'ncl_mlm'])
    parser.add_argument('--task', default='', type=str, required=True, help='what datasets',
                        choices=['asc', 'dsc', 'ssc', 'nli', 'newsgroup', 'celeba', 'femnist',
                                 'vlcs', 'cifar10', 'mnist', 'fashionmnist', 'cifar100',
                                 'wn18', 'yago','fbl'])
    ...
    parser.add_argument('--idrandom', default=1, type=int, required=False, help='(default=%(default)d)')
    ...
    parser.add_argument('--bert_mask_adapter_size', default=2000, type=int, required=False,
                        help='(default=%(default)d)')  # TODO my no effect: only change bert_adapter_size!!
    parser.add_argument('--bert_adapter_size', default=2000, type=int, required=False,
                        help='(default=%(default)d)')  # TODO my: TSM middle layer size (bert_size -linear-ReLU-> adapter_size -linear-ReLU-> bert_size)
    ...
    parser.add_argument('--debug', action='store_true')  # TODO my added for debugging
    parser.add_argument('--auto_resume', action='store_true')  # TODO my added automatic loading
    parser.add_argument('--eval_forward', action='store_true')  # TODO my eval modules after each step
    parser.add_argument('--log_pred', action='store_true')  # TODO my save preds in txt
    parser.add_argument("--yaml_param_num", default='new_model', type=str)  # TODO my to save models separately
    parser.add_argument("--model_save_path", default='', type=str)  # TODO my to save models separately
    parser.add_argument("--path_to_model_to_eval", default='', type=str)  # TODO my to save models separately
    parser.add_argument("--trained_model_path", default='', type=str)  # TODO my path to trained model
    parser.add_argument("--switch_positions", default='-1', type=str)  # TODO my tasks position to switch test and train set
    parser.add_argument("--load_trained_capsule_model",
                        action='store_true')  # TODO my load already trained model, and train it again
    parser.add_argument("--reuse_data",
                        action='store_false')  # TODO my load and use data if exists, or create and save in pickle
