...
class BertAdapter(nn.Module):
    ...
    def forward(self, x):
        ...
        return x + h # TODO my skip connection
        # return h
...
class BertAdapterMask(BertAdapter):
    def __init__(self, config):
        ...
        self.config = config
        self.smax = config.smax # My TODO extention
    ...
    def mask(self, t, s=1):
        if torch.cuda.is_available():  # TODO my code for local cpu run if else
...
class BertAdapterCapsuleMaskImp(BertAdapterMask):
    ...
    def forward(self, x, t, s):
        ...
        h = x + capsule_output  # ToDo my skip-connection
        ...
        return {'outputs': x + h} # ToDo my skip-connection
        # return {'outputs': h}
...
class BertAdapterOwm(nn.Module):
    ...
    def forward(self, x, sample=False):
        ...
        return {'outputs': x + h, 'x_list': x_list, 'h_list': h_list} # TODO my skip connection
        # return {'outputs': h, 'x_list': x_list, 'h_list': h_list}
