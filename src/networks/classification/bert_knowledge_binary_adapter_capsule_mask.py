...
class Net(torch.nn.Module):
    ...
    def __init__(self,taskcla,args):
        ...
        for t,n in self.taskcla: # TODO my code add binary prediction head for each KG
            self.last.append(torch.nn.Linear(args.bert_hidden_size,n)) # TODO my mask prediction head as last layer for knowledge
    ...
    def forward(self,t,input_ids, segment_ids, input_mask, targets, s=1):
        ...
        for t,i in self.taskcla:
            y.append(self.last[t](pooled_output)) # TODO my code masking task, input is sequence
